...
namespace LittleFairy_Race
{
    public class Thing_BloodNursery : Building, IThingHolder
	{
		...
		public List<RimWorld.SkillDef> key = new List<RimWorld.SkillDef>();
		...
		public override void ExposeData()
		{
			...
			Scribe_Collections.Look(ref SkillXP, "SkillXP", LookMode.Def, LookMode.Value, ref key, ref val);
		}
		...
		public override IEnumerable<Gizmo> GetGizmos()
		{
            ...
            {
				Command_Action command_Dev_InstanceBorn = new Command_Action();
				command_Dev_InstanceBorn.defaultLabel = "Dev:InstanceBorn";
				command_Dev_InstanceBorn.icon = Graphic_LitF.texture_stats;
				command_Dev_InstanceBorn.action = delegate
				{
					this.Nursery_Tick = 0;
				};
				yield return command_Dev_InstanceBorn;
			}
		}
				...
				if (this.Nursery_Core != null)
				{
					...
					if (!innerContainer.Where(x => x as Pawn != null && x.def.defName != "LittleFairy_Pawn").EnumerableNullOrEmpty())
                    {
						...
						else
						{
                            ...
                            {
								PawnGenerationRequest request = new PawnGenerationRequest(PawnKindDef.Named("LitF_Meefae"), null, PawnGenerationContext.NonPlayer, -1, forceGenerateNewPawn: false, allowDead: false, allowDowned: true, canGeneratePawnRelations: true, mustBeCapableOfViolence: false, 1f, forceAddFreeWarmLayerIfNeeded: false, allowGay: true, allowPregnant: false, allowFood: true, allowAddictions: true, inhabitant: false, certainlyBeenInCryptosleep: false, forceRedressWorldPawnIfFormerColonist: false, worldPawnFactionDoesntMatter: false, 0f, 0f, null, 1f, null, null, null, null, null, null, null, null, null, null, null, null, forceNoIdeo: false, forceNoBackstory: false, forbidAnyTitle: false, forceDead: false, null, null, null, null, null, 0f, DevelopmentalStage.Newborn);
                            ...
                            {
								// 子供が生まれる
								PawnGenerationRequest request = new PawnGenerationRequest(PawnKindDef.Named("LittleFairy_NurseryBorn"), Find.FactionManager.FirstFactionOfDef(FactionDef.Named("LitF_GentleWildLittleFairy")), PawnGenerationContext.NonPlayer, -1, forceGenerateNewPawn: true, allowDead: false, allowDowned: true, canGeneratePawnRelations: true, mustBeCapableOfViolence: false, 1f, forceAddFreeWarmLayerIfNeeded: false, allowGay: true, allowPregnant: false, allowFood: true, allowAddictions: true, inhabitant: false, certainlyBeenInCryptosleep: false, forceRedressWorldPawnIfFormerColonist: false, worldPawnFactionDoesntMatter: false, 0f, 0f, null, 1f, null, null, null, null, null, LitF_Config.AdultCondition ? 1.0f : 0.0f, LitF_Config.AdultCondition ? 1.0f : 0.0f, null, null, null, null, null, forceNoIdeo: false, forceNoBackstory: false, forbidAnyTitle: false, forceDead: false, null, null, null, null, null, 0f, LitF_Config.AdultCondition ? DevelopmentalStage.Adult : DevelopmentalStage.Newborn);
								pawn = PawnGenerator.GeneratePawn(request);
								pawn.ideo.SetIdeo(this.Nursery_Core.Ideo != null ? this.Nursery_Core.Ideo : null);
								// スキルのセット
								pawn.story.Childhood = DefDatabase<BackstoryDef>.AllDefs.Where(x => x.defName == "LitF_Child_NurseryBorn").FirstOrDefault();
								pawn.story.Adulthood = LitF_Config.AdultCondition ? DefDatabase<BackstoryDef>.AllDefs.Where(x => x.defName == "LitF_Adult_NurseryBorn").FirstOrDefault() : null;
